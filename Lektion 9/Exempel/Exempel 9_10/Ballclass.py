class Ball:
    ...
    def remove_ball(self):
        removed_ball = self.balls.pop(0)  
        if removed_ball.color == "red" and all(ball.color != "red" for ball in self.balls):
            self.balls.append(removed_ball)
        else:
            self.canvas.delete(removed_ball.ball) 
